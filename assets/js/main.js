...
            <header class="mb-8">
                                <a href="#" class="admin-back-btn bg-secondary hover:bg-teal-700 text-white font-bold py-2 px-4 rounded-md transition mb-4 inline-flex items-center">
...
        // ALTERAÇÃO AQUI (2/2): Adicionado o listener para o botão funcionar
        const backButton = adminContent.querySelector('.admin-back-btn');
        if (backButton) {
            backButton.addEventListener('click', (e) => {
                e.preventDefault();
                renderAdminOrdersView(); // Chama a função que mostra a lista de pedidos
            });
        }
